...
int Application::main(int argc,char *argv[])
  {
    ...
    BOOM::CommandLine cmd(argc,argv,"o:s:gr::b:p:P:");
    if(cmd.numArgs()!=9)
      throw BOOM::String("\n\
...
where -e evaluates performance of model using the given negative examples\n\
      ...
      -P <real> = use real value for pseudocounts (default is 0)\n\
\n");
    ...
    pseudocount=cmd.option('P') ? cmd.optParm('P').asFloat() : 0.0;
