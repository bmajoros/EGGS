...
\n");
    ...
    //##### DEBUGGING!!!
    /*
    model=model->reverseComplement();
    negModel=negModel->reverseComplement();
    BOOM::Vector<TrainingSequence*> newPosTest, newNegTest;
    revCompSeqs(posTest,newPosTest);
    revCompSeqs(negTest,newNegTest);
    posTest=newPosTest;
    negTest=newNegTest;
    */
    //#####
